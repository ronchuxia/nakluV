...
void Tutorial::ObjectsPipeline::create(RTG &rtg, VkRenderPass render_pass, uint32_t subpass) {
    ...
    {   //create pipeline
        ...
        //the rasterizer will cull back faces (clockwise) and fill polygons
        ...
        //multisampling will be disabled
        ...
        //all of the above structures get bundled together into one very large create info
        VkGraphicsPipelineCreateInfo create_info{
            .sType = VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_CREATE_INFO,
            .stageCount = uint32_t(stages.size()),
            .pStages = stages.data(),
            .pVertexInputState = &Vertex::array_input_state,    //use the vertex bindings of Vertex (alias: PosColVertex)
    ...
    //shader modules no longer needed now that pipeline is created
